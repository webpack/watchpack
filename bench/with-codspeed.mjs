/*
 * CodSpeed <-> tinybench bridge for watchpack benchmarks.
 *
 * Ported from webpack/enhanced-resolve's benchmark/with-codspeed.mjs, which
 * itself is derived from webpack's test/BenchmarkTestCases.benchmark.mjs.
 *
 ...
 * simulation mode. webpack and enhanced-resolve hit the same issue and use
 * @codspeed/core directly — we follow their lead.
 *
