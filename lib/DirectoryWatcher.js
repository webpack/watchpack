...
class DirectoryWatcher extends EventEmitter {
	...
	onWatchEvent(eventType, filename) {
		console.log(">>> onWatchEvent: ", eventType, filename)
				...
				fs.lstat(filePath, (err, stats) => {
					...
					if (err) {
						if (
							...
							console.log(">>> onWatchEvent2: ", filename, path.basename(this.path), eventType, filename)
	...
	onWatcherError(err) {
		console.log(">>> onWatcherError: ", err)
