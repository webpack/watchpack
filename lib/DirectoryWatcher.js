...
DirectoryWatcher.prototype.createNestedWatcher = function createNestedWatcher(directoryPath) {
...
DirectoryWatcher.prototype.setNestedWatching = function setNestedWatching(flag) {
...
DirectoryWatcher.prototype.getTimes = function getTimes() {
...
DirectoryWatcher.prototype.close = function close() {
  this.initialScan = false;
  this.watcher.close();
  if (this.nestedWatching) {
    Object.keys(this.directories).forEach(function fe(dir) {
