 ...
 * @property {number | boolean=} busyRetries number of retries on EBUSY (default: 3). Use `false` or `0` to disable retrying and restore the previous behavior.
 * @property {number=} busyRetryDelay delay in milliseconds between EBUSY retries (default: 100)
 */
 ...
 * @property {number | boolean=} poll true when need to enable polling mode for watching, otherwise false
 * @property {number | boolean=} busyRetries number of retries on EBUSY
 * @property {number=} busyRetryDelay delay in milliseconds between EBUSY retries
 */
