...
Watchpack.prototype.watch = function watch(files, directories, startTime) {
	...
	this.fileWatchers = files.map(function(file) {
		return this._fileWatcher(file, watcherManager.watchFile(file, startTime, this.options));
	}, this);
	this.dirWatchers = directories.map(function(dir) {
		return this._dirWatcher(dir, watcherManager.watchDirectory(dir, startTime, this.options));
	}, this);
